document.addEventListener('DOMContentLoaded', function() {
    const thumbnailsContainer = document.getElementById('photos');
    ...
    const updateFeaturedImage = (image, thumbnailElement) => {
        ...
        const allThumbnails = document.querySelectorAll('#photos img');
    ...
    document.querySelector('#photos img').classList.add('active');
